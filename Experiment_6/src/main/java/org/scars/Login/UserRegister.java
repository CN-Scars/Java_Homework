...
public class UserRegister {
    ...
    private static void initData() {
        User user = new User("迪丽热巴", "zz,123", new Date(), "18810319240", "zhangzheng@itcast.cn");
        User user2 = new User("吴宣仪", "zq,123", new Date(), "18618121193", "zhouqi@itcast.cn");
        USER_DATA.add(user);
        USER_DATA.add(user2);
    }
}
